...
var HIGHLIGHTS = [
  "26.10.2–11.22|Turku","26.9.18–27.1.17|London","26.8.29–11.1|New York","26.7.17-9.20|Eindhoven","26.7.9","26.6.23","26.6.18|New York","26.6.12|New York","26.5.26","26.4.28|Geneva","26.4.20|San Francisco","26.3.17–29|Hong Kong",
...
var D = [
  ...
  ["26.5.12|Berlin",           '<a href="https://diffrakt.space/events/trees-and-termites-ghosts-and-goddesses/"><b>diffrakt</b>, "Trees and Termites, Ghosts and Goddesses"</a>', "SCREENING", ["exhibition"]],
  ...
  ["26.3.10|New York",         '<b>The Wythe</b>, "XTRTRRSTRLS"', "SCREENING", ["exhibition"]],
  ...
  ["25.9.3–7|Linz",            '<a href="https://ars.electronica.art/panic/en/view/artists-perspective-23038ddb450c80e7a1a0e59cda51d5dc/"><b>Ars Electronica Festival</b>, Artist talk at the Expanded Conference, VH Award Presentation, Deep Space</a>', "EXHIBITION<br>TALK", ["exhibition","talk"], "25.9.3_Ars Electronica.jpg"],
  ...
  ["25.8.23|San Francisco",    '"Visions of Phosphine Earth", <b>Slash</b>', "SCREENING", ["exhibition"]],
  ...
  ["25.8.1|Idyllwild CA",      '"Visions of Phosphine Earth", <b>FWB Fest</b>, with Berggruen Institute', "SCREENING", ["exhibition"]],
  ...
  ["25.3.2|Los Angeles",       '<b>Now Instant Image Hall</b>, "Kevin Peter He, Wendi Yan, Alice Bucknell: Cinematic Engine"', "SCREENING", ["exhibition"]],
...
function injectStyles() {
  if (document.getElementById('wy-table-injected-style')) return;
  ...
  style.textContent = [
    ...
    '}',
    '.wy-table td.wy-date span,',
    '.wy-table td.wy-date span span {',
    ...
    '  white-space: nowrap !important;',
    '}',
    '.wy-table td.wy-type span,',
    '.wy-table td.wy-type span span {',
    '  font-size: 0.62em !important;',
    '  white-space: nowrap !important;',
    '  color: #bbb !important;',
    '}',
    ...
    '}',
    '.wy-table .wy-desc a,',
    '.wy-table .wy-desc a:link,',
    '.wy-table .wy-desc a:visited,',
    '.wy-table .bodycopy-2 a,',
    '.wy-table .bodycopy-2 a:link,',
    '.wy-table .bodycopy-2 a:visited {',
    '  color: #111 !important;',
    '  text-decoration: none !important;',
    '  border-bottom: 1px solid transparent !important;',
    '  transition: border-color 0.2s ease !important;',
    '}',
    '.wy-table .wy-solo-marker {',
    '  color: #e65100 !important;',
    '  margin-left: 2px !important;',
    '  font-weight: bold !important;',
    '  display: inline-block !important;',
    '}',
    '.wy-table tr[data-hi="1"] .wy-date {',
    '  color: #444 !important;',
    '}',
    '.wy-table tr[data-hi="1"] .wy-date span {',
    '  font-weight: 600 !important;',
    '  color: #444 !important;',
    '}',
    '.wy-table tr[data-hi="1"] .wy-desc {',
    '  font-weight: 500 !important;',
    '}',
    '.wy-table tr.wy-grand-prix td {',
    '  padding-top: 8px !important;',
    '  padding-bottom: 8px !important;',
    '}',
    '/* ROW HOVER - DARK BACKGROUND & WHITE TEXT */',
    '.wy-table tr:hover {',
    '  background: #111 !important;',
    '}',
    '.wy-table tr:hover td,',
    '.wy-table tr:hover td span,',
    '.wy-table tr:hover .wy-desc,',
    '.wy-table tr:hover .wy-desc span,',
    '.wy-table tr:hover .wy-desc b,',
    '.wy-table tr:hover .wy-desc strong,',
    '.wy-table tr:hover td a,',
    '.wy-table tr:hover td a:link,',
    '.wy-table tr:hover td a:visited,',
    '.wy-table tr:hover td a span,',
    '.wy-table tr:hover td a b,',
    '.wy-table tr:hover td a strong {',
    '  color: #f5f5f5 !important;',
    '}',
    '/* LINK HOVER - GUARANTEED PURE WHITE (NEVER BLUE) & CLEAN WHITE UNDERLINE */',
    '.wy-table td a:hover,',
    '.wy-table td a:hover span,',
    '.wy-table td a:hover b,',
    '.wy-table td a:hover strong,',
    '.wy-table tr:hover td a:hover,',
    '.wy-table tr:hover td a:hover span,',
    '.wy-table tr:hover td a:hover b,',
    '.wy-table tr:hover td a:hover strong,',
    '.wy-table tr:hover td a:focus,',
    '.wy-table tr:hover td a:active,',
    '.wy-table .bodycopy-2 a:hover,',
    '.wy-table .wy-desc a:hover {',
    '  color: #f5f5f5 !important;',
    '  border-bottom-color: #f5f5f5 !important;',
    '}',
    '/* HOVERED SUB-ELEMENTS (DATE, TYPE, SOLO MARKER, GLOW WITHOUT JITTER) */',
    '.wy-table tr:hover .wy-date span,',
    '.wy-table tr:hover .wy-date span span,',
    '.wy-table tr:hover .wy-type span,',
    '.wy-table tr:hover .wy-type span span {',
